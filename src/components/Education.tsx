        ...
        <div className="space-y-8">
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 transform hover:scale-105 group border border-white/10">
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                ...
                <h4 className="text-xl font-semibold text-cyan-300 mb-2">BSc Computer Science</h4>
                <p className="text-lg text-gray-300 mb-4">ST. Joseph College, Kovur</p>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 transform hover:scale-105 group border border-white/10">
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-white mb-2">Professional Course</h3>
                <h4 className="text-xl font-semibold text-cyan-300 mb-2">Full Stack Development</h4>
                <p className="text-lg text-gray-300 mb-4">Accord Info Matrix, Little Mount, Saidapet</p>
